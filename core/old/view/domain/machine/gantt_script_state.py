...
class GanttScriptGenerationProcessState(GanttScriptGenerationProcessStatePort):
    ...
    `.__ontobdc__/asset/ifc_work_schedule_view/` inside the container. Most
    states materialize one JavaScript file; EVENT_PROMOTERS_GENERATED
    materializes the two dDock event-promotion scripts as one logical step.
    """
