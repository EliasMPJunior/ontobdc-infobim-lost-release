...
class WorkStreamScriptGenerationProcessState(WorkStreamScriptGenerationProcessStatePort):
    ...
    Each state (after UNDEFINED) corresponds to one generation step under
    `.__ontobdc__/asset/work_stream_view/` inside the container. Most states
    materialize one JavaScript file; EVENT_PROMOTERS_GENERATED materializes
    the two dDock event-promotion scripts as one logical generation step.
    """
    ...
    def label(self, lang: str = "en") -> str:
        labels = {
            "en": {
                ...
                self.EVENT_PROMOTERS_GENERATED: "dDock Event Promoters Generated",
            ...
            "pt-br": {
                ...
                self.EVENT_PROMOTERS_GENERATED: "Promotores de Eventos da dDock Gerados",
    ...
    def description(self, lang: str = "en") -> str:
        descriptions = {
            "en": {
                ...
                self.EVENT_PROMOTERS_GENERATED: "component_event_promoter.js was generated as the Component-to-Shared promotion bridge; shared_event_promoter.js remains an empty Shared-to-Global scaffold.",
            ...
            "pt-br": {
                ...
                self.EVENT_PROMOTERS_GENERATED: "component_event_promoter.js foi gerado como a ponte de promocao Component-para-Shared; shared_event_promoter.js continua um esqueleto vazio de Shared-para-Global.",
                ...
                self.FILE_CATEGORY_SCRIPT_GENERATED: "file_category.js foi gerado: classifica recursos em categorias de exibicao a partir de file_display.ttl, em JS puro.",
