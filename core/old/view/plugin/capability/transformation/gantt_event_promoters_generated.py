...
from ontobdc.view.plugin.check.gantt_script_common import (
    script_is_fresh,
    script_path,
)
...
class GanttEventPromotersGeneratedCapability(TransformationCapability):
    METADATA = CapabilityMetadata(
        id=(
            "org.ontobdc.view.plugin.capability.transformation.target."
            "gantt_event_promoters_generated"
        ),
        version="1.0.0",
        name="Gantt dDock Event Promoters Generated",
        description=(
        ...
        tags=["view", "gantt", "script", "event", "transformation"],
        supported_languages=["en", "pt-br"],
        log_message={
            "info": {
                "en": (
                    "dDock event promoter JavaScript scaffolds were generated "
                    "under .__ontobdc__/asset/ifc_work_schedule_view/."
                ),
            },
            "debug_entry": {
                "en": (
    ...
    def label(self, lang: str = "en") -> str:
        return GanttScriptGenerationProcessState.EVENT_PROMOTERS_GENERATED.label(lang)

    def description(self, lang: str = "en") -> str:
        return GanttScriptGenerationProcessState.EVENT_PROMOTERS_GENERATED.description(lang)
    ...
    def execute(self, context: CliContextPort) -> Dict[str, Any]:
        ...
        return {
            "resulting_state": GanttScriptGenerationProcessState.EVENT_PROMOTERS_GENERATED,
