...
_CAPABILITY_ID_BY_STATE: Dict[GanttScriptGenerationProcessState, str] = {
    ...
    GanttScriptGenerationProcessState.EVENT_PROMOTERS_GENERATED: (
        "org.ontobdc.view.plugin.capability.transformation.target."
...
class GanttScriptGenerationStateTransitionHandler(
    ...
    """Execute the remaining gantt_view script generation states in the
    container that hosts `index.html`. The dDock event-promoter state
