...
class StorageEntityCommand(CliCommandPort):
    METADATA = CliCommandMetadata(
        ...
        description=(
            "Display a storage entity, list available Brasidata entities, "
        ...
        arguments=[
            {
                ...
                "valued": True,
                "description": (
                    "Display the persisted information for a storage entity."
                ),
                "usage": "ontobdc storage --entity <entity_uri>",
            },
            {
                "accepts": ["--all"],
                "valued": False,
                ...
                "usage": "ontobdc storage --entity --all",
            },
            {
                ...
                "usage": (
                    "ontobdc storage --container <container_id> "
                    "--entity <entity>"
                ),
            },
            {
                ...
                "usage": (
                    "ontobdc storage --create <instance_name> "
    ...
    def accepts(args: List[str]) -> bool:
        ...
        is_entity_all: bool = args == ["storage", "--entity", "--all"]
    ...
    def check(self) -> bool:
        ...
        if not entity_value:
            raise CliCommandArgumentException(
                "Usage: ontobdc storage --entity <entity> "
        ...
        if self._is_entity_create_request():
            ...
            if not create_value:
                raise CliCommandArgumentException(
                    "Usage: ontobdc storage --create <instance_name> "
                    "--entity <entity> [--container <container_id>]"
                )
    ...
    def _run_list_instances(self) -> CommandResponse:
        ...
        return CommandResponse(
            title="Storage Entity Instances",
            description=(
