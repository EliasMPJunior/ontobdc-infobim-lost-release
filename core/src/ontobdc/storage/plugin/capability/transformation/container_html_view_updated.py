...
class ContainerHtmlViewUpdatedCapability(TransactionCapability):
    ...
    def execute(self, context: CliContextPort) -> Dict[str, Any]:
        ...
        FilesystemAdapter.remove_file(index_path)
        FilesystemAdapter.remove_file(index_path.parent / "onto-file-viewer.html")
        FilesystemAdapter.remove_file(
        ...
        if etl_state_directory.is_dir():
            FilesystemAdapter.remove_directory_tree(etl_state_directory)
