...
class CliHealthProcessStatePort(str, Enum):
    """
    Base enum contract for CLI system-health verification states.
    """
    @abstractmethod
    def label(self, lang: str = "en") -> str:
        ...
    ...
    @staticmethod
    @abstractmethod
    def get_state(state: str) -> "CliHealthProcessStatePort":
        ...


class CliHealthStateEvaluatorPort(ABC):
    @abstractmethod
...
class CliHealthStateTransitionHandlerPort(ABC):
    @property
    @abstractmethod
