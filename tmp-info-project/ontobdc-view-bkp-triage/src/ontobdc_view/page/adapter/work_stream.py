  ...
  runtime.state = Object.assign(
    {
      ...
      // Which handle activeMountPath is a mount of. The slot is shared by
      // every path that mounts a container, so the path alone does not say
      // which directory Python is looking at.
      activeMountHandle: null,
