...
from ontobdc_view.surface.plugin.check.is_surface_validated.check import (
    is_valid_surface,
    main as check_surface_validated,
)
...
class SurfaceValidatedCapability(TransformationCapability):
    ...
    def execute(self, context: CliContextPort) -> Dict[str, Any]:
        ...
        document = SurfaceDocumentAdapter.set_state_marker(document, "surface_validated")
