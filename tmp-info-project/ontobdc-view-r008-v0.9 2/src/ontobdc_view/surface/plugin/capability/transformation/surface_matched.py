...
from ontobdc_view.surface.plugin.capability.transformation.data_gathered import DataGatheredCapability
from ontobdc_view.surface.plugin.check.is_surface_matched.check import main as check_surface_matched
...
class SurfaceMatchedCapability(TransformationCapability):
    ...
    def execute(self, context: CliContextPort) -> Dict[str, Any]:
        ...
        matches = SurfaceDocumentAdapter.normalize_matches(resolved_requests)

        document = SurfaceDocumentAdapter.upsert_json_script(self._surface.read(context), MATCHES_ID, matches)
