...
class OntoPdfFileTile extends HTMLElement {
  ...
  #buildTileElement() {
    ...
    template.innerHTML = OntoPdfFileTile.#TILE_MARKUP;
  ...
  #render() {
    ...
    if (this.dataset.tileClosed !== "true") {
      tileElement.querySelector("embed").setAttribute("src", href);
    }
    tileElement.querySelector(".open-link").href = href;
    tileElement.querySelector(".size").textContent = this.#formatBytes(size);
  }
}
