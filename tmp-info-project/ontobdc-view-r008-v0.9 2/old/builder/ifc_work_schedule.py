...
class IfcWorkSchedulePageDataTransitionHandler:
    """Drives one IfcWorkSchedule element's Page-data build through its statechart.
    ...
    def __init__(
        ...
        *,
        ...
        self._steps: Dict[IfcWorkSchedulePageDataProcessState, Callable[[], None]] = {
            IfcWorkSchedulePageDataProcessState.FACADES_LOCATED: self._locate_facades,
            IfcWorkSchedulePageDataProcessState.FACADE_DATA_GATHERED: self._gather_facade_data,
            IfcWorkSchedulePageDataProcessState.MISSING_DATA_FILLED: self._fill_missing_data,
            IfcWorkSchedulePageDataProcessState.RELATED_ENTITIES_RESOLVED: self._resolve_related_entities,
        }
        ...
        *,
        ...
        worker = StateWorkerAdapter(
            ...
            statechart_file_path=StatechartLocator.locate(
                __file__, "ifc_work_schedule_page_data.yaml"
            ),
        )
        worker.work()
