...
def test_parse_default_surface_layout_discovers_all_three():
    layouts = parse_default_surface_layout(_graph(THREE_TIER_TURTLE))
...
def test_default_surface_layout_ships_an_always_matching_fallback():
    layouts = default_surface_layout()
