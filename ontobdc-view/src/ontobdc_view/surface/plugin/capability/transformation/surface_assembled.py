...
from ontobdc_view.surface.plugin.check.is_surface_assembled.check import main as check_surface_assembled

#region debug-point (infobim-view-slow-crash): import assembly adapter metrics
...
class SurfaceAssembledCapability(TransformationCapability):
    ...
    def execute(self, context: CliContextPort) -> Dict[str, Any]:
        ...
        #endregion
        document = SurfaceDocumentAdapter.assemble_surface_markup(document, matches)
