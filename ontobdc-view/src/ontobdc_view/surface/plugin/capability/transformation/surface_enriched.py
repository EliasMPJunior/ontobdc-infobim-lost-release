...
from ontobdc_view.surface.plugin.check.is_surface_enriched.check import main as check_surface_enriched
...
class SurfaceEnrichedCapability(TransformationCapability):
    ...
    def execute(self, context: CliContextPort) -> Dict[str, Any]:
        ...
        document = SurfaceDocumentAdapter.upsert_json_script(document, JSONLD_ID, payload, "application/ld+json")
