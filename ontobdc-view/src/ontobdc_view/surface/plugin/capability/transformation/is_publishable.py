...
class IsPublishableCapability(TransformationCapability):
    ...
    def check(self, context: CliContextPort) -> bool:
        return SurfacePublicationAdapter.is_container_publishable(context)

    def execute(self, context: CliContextPort) -> Dict[str, Any]:
        result = SurfacePublicationAdapter.ensure_publishable(context)
